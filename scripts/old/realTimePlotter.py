...
class RealTimePlotter:
    def __init__(self, ang, signal_femoral, signal_gastrocnemius, filtered_speed, angSpeed, controlSignal, angSpeedRefHistory, errorHistory, xRange):
        ####################################
        # Grafico
        self.xRange = xRange
        ...
        timer.add_callback(self.plotter, ang, signal_femoral, signal_gastrocnemius, filtered_speed, angSpeed, controlSignal, angSpeedRefHistory, errorHistory)
        timer.start()
    ...
    def plotter(self, ang, signal_femoral, signal_gastrocnemius, filtered_speed, angSpeed, controlSignal, angSpeedRefHistory, errorHistory):
